 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.post('/', authMiddleware, validateContainer, ContainerController.create);
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.put('/:id', authMiddleware, validateContainerUpdate, ContainerController.update);
